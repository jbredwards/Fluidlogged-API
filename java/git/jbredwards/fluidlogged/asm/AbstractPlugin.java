...
public abstract class AbstractPlugin
{
    ...
    protected abstract boolean transform(InsnList instructions, MethodNode method, AbstractInsnNode insn, boolean obfuscated);
    //used to add local variables, returns the amount of variables added
    protected int addLocalVariables(List<LocalVariableNode> variables, LabelNode start, LabelNode end) { return 0; }
