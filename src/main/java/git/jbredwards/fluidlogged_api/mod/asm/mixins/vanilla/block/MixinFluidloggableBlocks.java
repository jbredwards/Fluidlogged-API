...
@Mixin({BlockAnvil.class, BlockBanner.class, BlockBasePressurePlate.class, BlockBeacon.class, BlockBrewingStand.class,
        ...
        BlockEndPortalFrame.class, BlockEnchantmentTable.class, BlockEndRod.class, BlockFenceGate.class, BlockFence.class,
        BlockFlowerPot.class, BlockHopper.class, BlockLadder.class, BlockLever.class, BlockPane.class,
        BlockPistonExtension.class, BlockRailBase.class, BlockRedstoneDiode.class, BlockRedstoneTorch.class,
        BlockRedstoneWire.class, BlockSign.class, BlockStairs.class, BlockTripWire.class, BlockTripWireHook.class})
