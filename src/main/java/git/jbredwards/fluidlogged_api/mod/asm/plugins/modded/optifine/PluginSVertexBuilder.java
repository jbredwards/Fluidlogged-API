...
public final class PluginSVertexBuilder implements IASMPlugin
{
    ...
    public boolean transform(@Nonnull final InsnList instructions, @Nonnull final MethodNode method, @Nonnull final AbstractInsnNode insn, final boolean obfuscated, final int index) {
         ...
         * int renderType = Hooks.getRenderType(block.getRenderType(blockState), block).ordinal();
         */
        if(checkMethod(insn, obfuscated ? "func_149645_b" : "getRenderType")) {
            instructions.insert(insn, genMethodNode("getRenderType", "(Lnet/minecraft/util/EnumBlockRenderType;Lnet/minecraft/block/Block;)Lnet/minecraft/util/EnumBlockRenderType;"));
    ...
    {
        @Nonnull
        public static EnumBlockRenderType getRenderType(@Nonnull final EnumBlockRenderType oldType, @Nonnull final Block block) {
            return block instanceof BlockLiquid ? EnumBlockRenderType.LIQUID : oldType;
        }
    }
}
