...
public abstract class MixinBlockConcretePowder
{
    /**
    ...
    private boolean dry(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state) {
        return world.setBlockState(pos, Blocks.CONCRETE.getDefaultState()
                .withProperty(BlockConcretePowder.COLOR, state.getValue(BlockConcretePowder.COLOR)));
    }
}
