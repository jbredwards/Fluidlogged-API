 ...
 *
 */
public final class LegacyWorldFixer extends Block implements ITileEntityProvider
{
    final Fluid fluid;

    public LegacyWorldFixer(@Nonnull Fluid fluid) {
    ...
    public static final class Tile extends TileEntity implements ITickable
    {
        ...
        public void update() {
            if(stored != null && !world.isRemote && world.isBlockLoaded(pos)) {
                final FluidState fluidState = FluidState.of(((LegacyWorldFixer)getBlockType()).fluid);
